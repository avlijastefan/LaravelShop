...
class CategoryController extends Controller
{
    ...
    public function categories($categories)
    {
        ...
        if (!$categoryW_Parents->isEmpty()):
            ...
            // Product category
            $catSlugFromURL = array_slice($fullURL, -2, 1);

            // PRODUCT data
            $productDATA = Product::productDATA_bySLUG($categorySLUG,$catSlugFromURL);
            ...
            return view('product.index', compact('slug','favLIST','metaTitle','metaDescription','metaKeywords',
                                                    ...
                                                    'catFromURL',
                                                    'ratingOptions','productRate','ratingComments','ulogovan','daLiJeKupioProizvod','daLiMozeDaOcenjujeIKomentarise',
                                                    'relatedProducts'));
