...
class AppSpotlight extends Model
{
    ...
    public static function couponsData($baseURL,$apikey,$barcode) {
	...
	public static function insertTransaction($baseURL,$transactionDATA) {

		$apiURL = 'int/insert-transaction-v2';
