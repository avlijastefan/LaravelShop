						...
						<div class="col-xl-12">
                            ...
                            <div class="form-group">
                                ...
                                @elseif ($atribut['attr_type_id'] == 2)
                                    ...
                                    <select id="mbdSEL_{{ $atribut['attr_id'] }}" class="mdb-select md-form col-xl-6 pl-0 pr-0 mt-2 mb-0" name="attr_{{ $atribut['attr_id'] }}">
                                ...
                                @elseif ($atribut['attr_type_id'] == 3)
                                    ...
                                    <select id="mbdSELMulti_{{ $atribut['attr_id'] }}" class="mdb-select md-form col-xl-6 pl-0 pr-0 mt-2 mb-0" name="attr_{{ $atribut['attr_id'] }}[]" data-label-select-all="@lang('shop.title_select_all')" data-label-options-selected="@lang('shop.title_selected_options')" multiple="">
                                        <option value="" disabled selected>@lang('shop.title_choose')</option>
