...
class ProductController extends Controller
{
    ...
    public function cart()
    {
        ...
        // ako je povezan, prikazujem sve kupone za korisnika
        $sviKuponi = array();
        $sviKuponi_challengeQuantity = array();

        if ($loyDATA && $loyDATA->active == 1 && $ulogovan->loy_barcode != null):

            //svi kuponi
            $sviKuponi = AppSpotlight::couponsData($loyDATA->api_base_url,$loyDATA->api_key,$ulogovan->loy_barcode);
